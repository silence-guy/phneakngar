...
import { canonicalForCrawl, matchesPatterns, stripFragment, } from "../src/url-utils.js";
import { parseSitemapEntries, parseSitemapIndex, extractSitemapUrlFromRobots, sortSitemapEntries, } from "../src/sitemap.js";
...
describe("url-utils", () => {
    it("canonicalForCrawl collapses fragment and trailing slash", () => {
        expect(canonicalForCrawl("https://ex.com/docs#install")).toBe("https://ex.com/docs");
        expect(canonicalForCrawl("https://ex.com/docs/")).toBe("https://ex.com/docs");
    });
    it("stripFragment drops hash", () => {
        expect(stripFragment("https://ex.com/a#b")).toBe("https://ex.com/a");
    });
    it("matchesPatterns include/exclude", () => {
        expect(matchesPatterns("https://ex.com/docs/a", ["/docs/"], undefined)).toBe(true);
        expect(matchesPatterns("https://ex.com/blog/a", ["/docs/"], undefined)).toBe(false);
        expect(matchesPatterns("https://ex.com/docs/a", undefined, ["/docs/"])).toBe(false);
    });
});
describe("sitemap", () => {
