...
export function extractTitle(html: string): string {
  ...
  if (og?.[1]) return collapseWs(decodeEntities(og[1])).slice(0, 500);
  return "";
}
 ...
 */
export function htmlToMarkdown(html: string, maxChars = 30_000): string {
...
export function extractFromHtml(html: string, maxChars = 30_000): ExtractResult {
