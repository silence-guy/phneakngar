...
interface HealthServerOptions {
  /** Async to allow executable probes that don't block the event loop. */
  detectHeadroom?: () => Promise<HeadroomHealth>;
...
function canRunExecutable(executable: string, env: NodeJS.ProcessEnv): Promise<boolean> {
...
export async function detectHeadroomHealth(
...
export function createHealthServer(
  ...
  async function currentHeadroom(): Promise<HeadroomHealth> {
