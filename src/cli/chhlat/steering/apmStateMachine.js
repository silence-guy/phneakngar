...
export function createInitialApmState() {
    return {
        isIdle: false,
...
/* Phase transitions                                                   */
/* ------------------------------------------------------------------ */
export function reduceApmIdleState(state, input) {
    return { nextState: { ...state, isIdle: input.isIdle } };
}
export function reduceApmGatedToolUse(state, input) {
...
export function reduceApmGatedCompaction(state, input) {
...
export function reduceApmGatedAssistantContinuation(state) {
    return { nextState: { ...state, isIdle: false, phase: "assistant_continuation" } };
}
/* ------------------------------------------------------------------ */
/* Delivery decisions (emit effects)                                   */
/* ------------------------------------------------------------------ */
export function reduceApmGatedFlushReadiness(state, input) {
    if (!input.isGated)
...
export function reduceApmGatedTurnEnd(state, input = {}) {
...
export function reduceApmGatedError(state, input = {}) {
...
export function reduceApmGatedFlush(state, input) {
    return { nextState: { ...state, lastFlushReason: input.reason } };
}
export function reduceApmGatedRecentEvent(state, input) {
...
/* ------------------------------------------------------------------ */
export function reduceApmGatedEnqueue(state, message) {
    return {
        nextState: {
            ...state,
...
/* ------------------------------------------------------------------ */
export function reduceApmStalledRecoveryTermination(state, input) {
    if (input.inboxLength === 0) {
...
export function reduceApmStartupTimeoutTermination(state, input) {
