...
import { buildJudgmentPolicyContextBlock, readJudgmentPolicy, } from "@phneakngar/shared";
import { tempDir } from "../../lib/platform.js";
import { cmdPrefix } from "../../lib/env.js";
import { writeFileSync, readFileSync, lstatSync, symlinkSync, unlinkSync, existsSync, readlinkSync, copyFileSync, } from "fs";
...
`;
export function resolveInstruction(text, selfAgentId) {
    let result = text;
...
export function buildInstructionContent(task) {
...
export function hasContentChanged(filePath, newContent) {
    try {
...
export function ensureSymlinks(workDir) {
...
export function writeInstructionFileIfChanged(workDir, task) {
