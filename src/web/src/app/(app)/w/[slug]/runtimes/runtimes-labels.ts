...
export const RUNTIMES_LABELS = {
  ...
  updateDaemonTitle: "ធ្វើបច្ចុប្បន្នភាព daemon",
  ...
  startDaemon: "ចាប់ផ្តើម Daemon",
  daemonStarted: "បានចាប់ផ្តើម daemon",
  startDaemonFailed: "មិនអាចចាប់ផ្តើម daemon បានទេ",
  ...
  rescanTriggered: "បានចាប់ផ្តើមស្កេនឡើងវិញ — daemon នឹងចាប់ផ្តើមឡើងវិញដើម្បីរកបរិស្ថានដំណើរការ",
...
export function updateDaemonDescription(displayName: string): string {
  return `ការនេះនឹងធ្វើបច្ចុប្បន្នភាព daemon នៅលើ "${displayName}" ទៅកំណែ CLI ចុងក្រោយ។ daemon នឹងចាប់ផ្តើមឡើងវិញកំឡុងពេលធ្វើបច្ចុប្បន្នភាព។`;
}

export function rescanRuntimesDescription(displayName: string): string {
  return `ការនេះនឹងចាប់ផ្តើម daemon នៅលើ "${displayName}" ឡើងវិញ ដើម្បីរកបរិស្ថានដំណើរការដែលមាន (Claude Code, Codex, OpenCode)។`;
}
