...
vi.mock("@opennextjs/cloudflare", () => ({
  getCloudflareContext: vi.fn(() => ({
    env: { DB: {}, EMAIL_NOTIFY_SECRET: "notify-secret", EMAIL_WORKER: { fetch: mockEmailWorkerFetch } },
  })),
}));
...
vi.mock("@/lib/middleware/auth", () => ({
  withAuth: vi.fn((handler: any) => async (req: any, ctx?: any) => {
    ...
    return handler(req, { env: { DB: {}, EMAIL_NOTIFY_SECRET: "notify-secret", EMAIL_WORKER: { fetch: mockEmailWorkerFetch } }, userId: "u1", email: "u@t.com", params });
  }),
}));
