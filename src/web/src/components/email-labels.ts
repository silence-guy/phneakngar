export const EMAIL_LABELS = {
  compose: {
    ...
    discard: "បោះបង់",
    send: "ផ្ញើ",
    sendForApproval: "ផ្ញើសម្រាប់អនុម័ត",
    requiresApproval: "ត្រូវការអនុម័តមុនផ្ញើ",
    requiresApprovalHint: "អ៊ីមែលនឹងរង់ចាំអនុម័ត មិនផ្ញើភ្លាម",
    from: "ពី",
    to: "ទៅ",
    subject: "ប្រធានបទ",
  ...
  page: {
    ...
    noPendingApprovalEmails: "គ្មានអ៊ីមែលរង់ចាំអនុម័ត",
    openApprovals: "បើកការអនុម័ត",
    ...
    sent3: "បានផ្ញើអ៊ីមែល",
    queuedForApproval: "បានដាក់ជួររង់ចាំអនុម័ត",
