...
/**
 * Grok brand mark (xAI) — official monogram path geometry as used for the Grok
 * product icon. Fills with currentColor so it matches other provider logos on
 * light/dark surfaces (including the CRT landing panel).
 */
