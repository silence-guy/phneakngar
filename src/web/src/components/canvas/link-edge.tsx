    ...
    <>
      ...
      <EdgeLabelRenderer>
        <button
          ...
          className={`text-[11px] leading-tight bg-background/50 px-2 py-0.5 rounded-md truncate cursor-pointer transition-colors italic ${hovered ? "text-muted-foreground" : "text-muted-foreground/40"
            }`}
