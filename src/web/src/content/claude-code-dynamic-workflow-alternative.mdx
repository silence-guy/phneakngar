...
We built something different at ភ្នាក់ងារ because we needed agents that remember things tomorrow and can hand off work to teammates. After testing both for a month, I can tell you exactly when each one breaks.
...
ភ្នាក់ងារ does this. While dynamic workflows only work in Claude Code, ភ្នាក់ងារ connects to Codex, OpenCode, and Claude Code today. OpenClaw and Hermes Agent coming Q3.
...
| Feature | Claude Code Dynamic Workflow | Email Coordination (ភ្នាក់ងារ) |
|---------|------------------------------|----------------------------|
...
Hit phneakngar.ai, make an account. You get Donia immediately.
...
**About ភ្នាក់ងារ:** Open-source agent coordination platform. Self-hosted option. Works with Codex/OpenCode/Claude Code. [GitHub](https://github.com/phneakngarai/phneakngar) | [Docs](https://github.com/phneakngarai/phneakngar/blob/main/AGENTS.md)
