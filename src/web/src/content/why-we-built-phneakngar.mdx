...
![You are the message bus](/blog/why-we-built-phneakngar/hero.svg)
...
![Project-centric vs agent-centric](/blog/why-we-built-phneakngar/wrong-axis.svg)
...
![Email as persistent memory](/blog/why-we-built-phneakngar/email-memory.svg)
...
In ភ្នាក់ងារ, that context layer is email. Async, persistent, and contextual by design. You talk to your agents the way you'd message a colleague. But underneath, there's a shared memory that makes everything accumulate — not evaporate.

The interface is familiar. The capability is not.

## One Person, A Thousand Agents

![One person, a thousand agents](/blog/why-we-built-phneakngar/agent-company.svg)

I built ភ្នាក់ងារ's MVP in one week with Claude Code. After that first week, I used ភ្នាក់ងារ to build ភ្នាក់ងារ. My planner breaks down features. My coder implements them. My CMO writes the launch copy. I set direction once. They execute.
...
ភ្នាក់ងារ is open source. It runs on your machine. Your data stays yours. Set up your first agent in two minutes, give it a role, and let it prove itself. Then add another. Then another.

[Get started →](https://github.com/phneakngarai/phneakngar)
