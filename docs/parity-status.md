...
| Live Slack/Telegram send in production | **Intermediate only** — requires operator-set live + token; staging proof checklist in `docs/gateway-live-runbook.md` + `docs/gateway-live-telegram-proof.md`; no OAuth marketplace / multi-region claim |
